...
class JsonDecoder {
    ...
    class func  decodeNews(jsonString:NSString) -> Array<Notizie> {
        ...
        for notiziaDict in json {
            ...
            var n = Notizie (category: notiziaDict["categoria"] as String, date: dateFormatter.dateFromString(notiziaDict["data"] as String) as NSDate! , title: notiziaDict["title"] as String, image: UIImage(data: data!)!, body: notiziaDict["body"] as String)
