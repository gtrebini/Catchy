...
class FollowedStoriesVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, SideBarDelegate {
    ...
    @IBOutlet var todayIsAbout: UILabel!
